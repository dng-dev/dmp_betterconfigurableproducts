...
VENDOR:=DerModPro
MODULE:=BCP
ARCHIVE_COLLECTION:=app js skin
# End edit here
######################################################
...
#Paths and zip-file and ta-file
...
doc: $(DOC_PUBLIC_PATH)/ChangeLog.pdf $(DOC_INTERN_PATH)/Entwicklerdokumentation.pdf $(DOC_INTERN_PATH)/FeatureRequests.pdf $(DOC_INTERN_PATH)/Specification.pdf  $(DOC_INTERN_PATH)/KnownIssues.pdf
...
$(DOC_INTERN_PATH)/FeatureRequests.pdf: $(DOC_SOURCE_PATH)/FeatureRequests.rst $(DOC_SOURCE_PATH)/netresearch.style
		rst2pdf -b 1 -o $(DOC_INTERN_PATH)/FeatureRequests.pdf -s $(DOC_SOURCE_PATH)/netresearch.style $(DOC_SOURCE_PATH)/FeatureRequests.rst --real-footnotes
